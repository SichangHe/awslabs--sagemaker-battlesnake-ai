...
def simulate(env, net, heuristics, number_of_snakes, use_random_snake):
    ...
    for i in range(number_of_snakes):
        ...
        previous_move[agent_id] = {"state": None, "reward": None, "action": None}
    ...
    while True:
        ...
        for i in range(number_of_snakes):
            ...
            state_i, obs = build_state_for_snake(
                state, i, previous_move[agent_id]["state"]
            )
        ...
        for i in range(number_of_snakes):
            ...
            action = actions[i]
            reward = rewards[i]
            previous_move[agent_id] = {"state": obs, "reward": reward, "action": action}
