...
class MyLauncher(SageMakerRayLauncher):
    ...
    def register_env_creator(self):
        register_env(
            "MultiAgentBattlesnake-v1",
            lambda _: MultiAgentBattlesnake(
    ...
    def on_episode_end(self, info):
        ...
        for i in range(self.num_agents):
            ...
            info["episode"].custom_metrics["policy{}_max_len".format(i)] = (
                snake_max_len[i]
            )
    ...
    def on_train_result(self, info):
        ...
        for i in range(self.num_agents):
            ...
            max_lens_per_policy.append(
                info["result"]["custom_metrics"]["{}_max_len_max".format(agent_id)]
            )
        ...
        info["result"]["episode_len_max"] = max(
            info["result"]["hist_stats"]["episode_lengths"]
        )
        info["result"]["episode_len_min"] = min(
            info["result"]["hist_stats"]["episode_lengths"]
        )
    ...
    def get_experiment_config(self):
        ...
        configs = {
            ...
            "model": {
                ...
                "custom_options": {"max_map_height": 21},
            },
            "multiagent": {
                "policies": policies,
