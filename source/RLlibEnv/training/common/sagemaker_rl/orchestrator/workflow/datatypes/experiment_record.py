class ExperimentRecord:
    ...
    def __init__(
        ...
        self._last_trained_model_id = training_workflow_metadata.get(
        ...
        self._last_hosted_model_id = hosting_workflow_metadata.get(
            "last_hosted_model_id", None
        )
        self._next_model_to_host_id = hosting_workflow_metadata.get(
        ...
        self._last_joined_job_id = joining_workflow_metadata.get(
        ...
        self._evaluation_state = evaluation_workflow_metadata.get(
    ...
    def to_ddb_record(self):
        ...
        self.training_workflow_metadata["last_trained_model_id"] = (
            self._last_trained_model_id
        )
        self.training_workflow_metadata["next_model_to_train_id"] = (
            self._next_model_to_train_id
        )

        self.hosting_workflow_metadata["hosting_state"] = self._hosting_state
        self.hosting_workflow_metadata["last_hosted_model_id"] = (
            self._last_hosted_model_id
        )
        self.hosting_workflow_metadata["next_model_to_host_id"] = (
            self._next_model_to_host_id
        )
        ...
        self.evaluation_workflow_metadata["last_evaluation_job_id"] = (
            self._last_evaluation_job_id
        )
        self.evaluation_workflow_metadata["next_evaluation_job_id"] = (
            self._next_evaluation_job_id
        )
