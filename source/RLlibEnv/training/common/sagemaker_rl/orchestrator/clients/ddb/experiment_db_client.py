...
class ExperimentDbClient(object):
    ...
    def update_experiment_last_trained_model_id(
        self, experiment_id, last_trained_model_id
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id},
    ...
    def update_experiment_next_model_to_train_id(
    ...
    def update_experiment_last_hosted_model_id(
        self, experiment_id, last_hosted_model_id
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id},
    ...
    def update_experiment_next_model_to_host_id(
    ...
    def update_experiment_last_evaluation_job_id(
        self, experiment_id, last_evaluation_job_id
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id},
    ...
    def update_experiment_next_evaluation_job_id(
