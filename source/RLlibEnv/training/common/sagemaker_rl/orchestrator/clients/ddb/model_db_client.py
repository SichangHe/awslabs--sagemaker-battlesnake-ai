...
class ModelDbClient:
    ...
    def get_model_record_with_retry(self, experiment_id, model_id, retry_gap=5):
        ...
        if model_record is None:
            logger.warn(
                "Model Record not found. Waiting for 5 seconds, before retrying."
            )
    ...
    def update_model_input_data_s3_prefix(
        self, experiment_id, model_id, input_data_s3_prefix
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "model_id": model_id},
    ...
    def update_model_s3_model_output_path(
        self, experiment_id, model_id, s3_model_output_path
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "model_id": model_id},
    ...
    def update_model_eval_scores_and_state(
        self, experiment_id, model_id, eval_scores, eval_state
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "model_id": model_id},
    ...
    def update_model_training_start_time(
        self, experiment_id, model_id, training_start_time
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "model_id": model_id},
    ...
    def update_model_training_end_time(
        self, experiment_id, model_id, training_end_time
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "model_id": model_id},
