...
class JoinDbClient(object):
    ...
    def update_join_job_join_query_ids(
        self, experiment_id, join_job_id, join_query_ids
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "join_job_id": join_job_id},
    ...
    def update_join_job_obs_start_time(
        self, experiment_id, join_job_id, obs_start_time
    ):
        self.table_session.update_item(
            Key={"experiment_id": experiment_id, "join_job_id": join_job_id},
