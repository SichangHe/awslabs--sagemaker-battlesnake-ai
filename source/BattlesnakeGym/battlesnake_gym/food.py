...
from .utils import generate_coordinate_list_from_binary_map, get_random_coordinates
...
class Food:
    ...
    def spawn_food(self, snake_map):
        ...
        if len(self.food_spawn_locations) > 0:
            ...
            locations = get_random_coordinates(
                self.map_size, 1, excluding=snake_locations
            )
