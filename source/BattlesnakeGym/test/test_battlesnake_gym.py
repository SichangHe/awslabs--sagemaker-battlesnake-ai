...
class TestBattlesnakeGym(unittest.TestCase):
    ...
    def test_snake_eaten_adjacent_tile_same_size(self):
        ...
        env.food.max_turns_to_next_food_spawn = (
            2  # Hack to make sure that food is spawned every turn
        )
    ...
    def test_spawning(self):
        ...
        self.assertTrue(
            env.food.locations_map[food_location[0][0], food_location[0][1]] == 1
        )
        env.close()
    ...
    def test_states(self):
        ...
        observation, _, _, _ = simulate_snake(
            env, actions, render=False, break_with_done=False
        )
